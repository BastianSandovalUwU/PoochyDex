...
export const pokemonRedBlueData: Games = {
  ...
  gameHistory: `El jugador toma el mando de un niño que vive en Pueblo Paleta, y ha cumplido la edad para poder irse de su casa y dedicarse a entrenar Pokémon. El nombre del protagonista puede ser escogido por el jugador, aunque su nombre genérico es Rojo. El profesor Oak te permitirá elegir uno de entre tres Pokémon iniciales (Bulbasaur, Charmander y Squirtle) para iniciar la aventura y poder combatir contra otros Pokémon salvajes y entrenadores. Al mismo tiempo se presenta al nieto del profesor Oak que también escogerá a su Pokémon inicial y se convertirá en tu rival durante el videojuego, por lo que deberás combatirlo varias veces. La meta principal del videojuego es llegar a la Liga Pokémon y enfrentarse al implacable Alto Mando. Para ello el jugador debe reunir las ocho medallas de gimnasio que se consiguen derrotando a los líderes de cada gimnasio Pokémon ubicados en distintas partes de la región Kanto. Para avanzar en su viaje el jugador debe sortear todo tipo de obstáculos, cumplir objetivos y entrenar constantemente a los Pokémon de su equipo para que aumenten su nivel y aprendan nuevos movimientos. Dentro de la aventura además el jugador deberá hacer frente a un grupo de villanos conocidos como el Team Rocket liderados por el misterioso Giovanni quienes con sus ambiciosos planes amenazan el bienestar de las personas y los Pokémon de Kanto. Otro objetivo del videojuego es completar la Pokédex para el profesor Oak, pero para ello el jugador necesita intercambiar Pokémon con otro que tenga la otra edición, como en la mayoría de los videojuegos de Pokémon.`,
  summary: `Pokémon Rojo y Pokémon Azul (Pokémon Red y Pokémon Blue en inglés, ポケットモンスター 赤 Pocket Monsters Aka y ポケットモンスター青 Pocket Monsters Ao en japonés) son los dos primeros videojuegos de Pokémon que fueron lanzados al mercado occidental para la consola portátil Game Boy y posteriormente el 27 de febrero de 2016 se estrenó en la eShop de Nintendo 3DS. Estos videojuegos utilizan el motor y los gráficos del videojuego japonés Pokémon Azul, aunque la disponibilidad de Pokémon se corresponde con las ediciones japonesas Pokémon Rojo y Pokémon Verde (los primeros dos videojuegos Pokémon). El término edición (versión en inglés) se debe a que ambos videojuegos son casi idénticos. Su única diferencia a grandes rasgos es la disponibilidad de Pokémon, puesto que cada edición presenta 11 criaturas exclusivas que no aparecen en la otra edición. Esta es una característica que se mantendría en todos los títulos siguientes de Pokémon Este videojuego presenta a los 151 Pokémon originales que luego se denominarían 'la primera generación'.`,
  releaseDates:
    [
      {
        console: "Game Boy",
...
export const pokemonYellowData: Games = {
  ...
  developedBy: "Game Freak",
  platforms: ["Game Boy", "Nintendo 3DS (Consola Virtual)"],
  gameHistory: `Sigue la misma historia que las ediciones originales, pero añadiendo contenido basado en el anime. Encarnando a Rojo (rediseñado para parecerse a Ash Ketchum), se recibe como Pokémon inicial a Pikachu de manos del profesor Oak. El rival será Azul (rediseñado para parecerse más a Gary Oak), quien recibirá un Eevee y con quien se tendrán enfrentamientos en varias ocasiones a lo largo de la aventura. Una vez obtenido a Pikachu, iniciará una aventura a lo largo de la región de Kanto con el objetivo de atrapar a todos los Pokémon para completar la Pokédex, formar un equipo, reunir las ocho medallas de gimnasio para desafiar al Alto Mando y al campeón de la Liga Pokémon, y así convertirse en el mejor entrenador Pokémon del mundo. Sin embargo, al igual que en Pokémon Rojo y Azul, estará presente el Team Rocket, una malvada organización que se dedica a hacer fechorías con los Pokémon. Pero tres miembros en especifico aparecerán de forma recurrente en la aventura: Jessie, James y Meowth, como ocurre en el anime.`,
