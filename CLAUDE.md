...
**Angular 19 with NgModules** (not standalone components by default). Lazy-loaded feature modules are declared under `src/app/modules/` and wired via `app.routing.ts`.
